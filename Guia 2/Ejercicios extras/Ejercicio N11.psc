Algoritmo ejercicio_11
	...
	Si (nota1 < nota2) y (nota1 < nota3) y (nota1 < nota4) Entonces
		...
		Escribir "La nota eliminada es la primera ingresada: " nota1 
		Escribir "El promedio es de: " resultado
	SiNo
		Si (nota2 < nota1) Y (nota2 < nota3) Y (nota2 < nota4) Entonces
			resultado = (nota1 + nota3 + nota4) / 3
			Escribir "La nota eliminada es la segunda ingresada: " nota2
			Escribir "El promedio es de: " resultado
		SiNo
			Si (nota4 < nota1) Y (nota4 < nota2) Y (nota4 < nota3) Entonces
				resultado = (nota1 + nota2 + nota4) / 3
				Escribir "La nota eliminada es la tercera ingresada: " nota3
				Escribir "El promedio es de: " resultado
			SiNo
				resultado = (nota1 + nota2 + nota3) / 3
				Escribir "La nota eliminada es la cuarta ingresada: " nota4
				Escribir "El promedio es de: " resultado
			Fin Si
		Fin Si
	Fin Si
